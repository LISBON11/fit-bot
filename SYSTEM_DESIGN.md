...
```mermaid
graph LR
    subgraph "Один человек (user_id = 550e...)"
        U["👤 User<br/>id: 550e...<br/>name: Лиза"]
    end

    subgraph "Точки входа (auth_providers)"
        T["📱 Telegram<br/>provider: telegram<br/>id: 123456789"]
        E["📧 Email<br/>provider: email<br/>id: liza@gmail.com"]
        G["🍎 Apple<br/>provider: apple<br/>id: apple-sub-xxx"]
    end
